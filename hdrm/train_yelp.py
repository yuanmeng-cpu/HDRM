...
def check_ckpt(lr, dlr, layer, alpha, steps, sample, min_, max_, dims, scale, act, beta, log, log_num):
	...
	file_name = f'lgn-yelp_noisy-{log}.pth.tar'
										...
										for max_ in max_list:
											...
											for dims in dims_list:
												for i, scale in enumerate(scale_list):
													...
													pid = run_program(lr, dlr, layer, alpha, steps, int(steps*sample), min_, max_, dims, scale, act, beta, log, log_num, gpu=gpu_list[log_num%4])
